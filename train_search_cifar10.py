...
def sample_cifar10(batch_size, image_size):
  ...
  dataset = torchvision.datasets.CIFAR10("../../data/", transform=transform, target_transform=None, download=True)
...
def main():
  ...
  # Define model
  model_single = Network(n_channels, args.n_flow, args.n_block, n_bins, affine=args.affine, conv_lu=not args.no_lu)
